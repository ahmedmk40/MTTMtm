    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('compliance_officer', 'Compliance Officer'), ('fraud_analyst', 'Fraud Analyst'), ('risk_manager', 'Risk Manager'), ('system_admin', 'System Administrator'), ('data_analyst', 'Data Analyst'), ('executive', 'Executive')], max_length=20, null=True, verbose_name='Role')),
