"""
Script to create sample transaction data for testing without triggering signals.
"""
...
# Store the original signal connections
original_receivers = post_save.receivers
post_save._clear_dead_receivers()
...
def create_sample_transactions(count=50):
    ...
    for i in range(count):
        ...
        transaction.save_base(raw=True)
...
if __name__ == '__main__':
    try:
        ...
        # Restore the original signal connections
